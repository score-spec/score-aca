FROM golang:1.26rc2-alpine@sha256:1a69751cd20c96286c1d928a18254837ae2cdcef6b96293d6f4d802caea92c43 AS builder
...
COPY . .
RUN CGO_ENABLED=0 GOOS=linux go build -ldflags="-X github.com/score-spec/score-aca/internal/version.Version=${VERSION}" -o /usr/local/bin/score-aca ./cmd/score-aca
